...
class TeacherCourseCreateScreen extends StatefulWidget {
  const TeacherCourseCreateScreen({super.key});
    ...
    switch (language) {
      case 'uz':
        switch (key) {
          ...
          case 'create_course_button': return "Fan Yaratish";
          case 'please_fill_all_fields': return "Iltimos, barcha maydonchalarni to'ldiring";
          case 'course_created_success': return "Fan muvaffaqiyatli yaratildi!";
          default: return key;
        }
      case 'ru':
        switch (key) {
          ...
          case 'create_course_button': return "Создать Курс";
          case 'please_fill_all_fields': return "Пожалуйста, заполните все поля";
          case 'course_created_success': return "Курс успешно создан!";
          default: return key;
        }
      case 'en':
      default:
        switch (key) {
          ...
          case 'create_course_button': return "Create Course";
          case 'please_fill_all_fields': return "Please fill all fields";
          case 'course_created_success': return "Course created successfully!";
          default: return key;
        }
    }
  }
  ...
  Future<void> _createCourse() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(_getLocalizedString('course_created_success', context)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(
          _getLocalizedString('create_course', context),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Add course name, room number, and select class",
                      style: GoogleFonts.poppins(
                        fontSize: 14,
              ...
              SizedBox(
                ...
                child: _loading
                    ...
                    : ElevatedButton(
                        ...
                        child: Text(
                          _getLocalizedString('create_course_button', context),
                          style: GoogleFonts.poppins(
                            fontSize: 16,
